...
import com.island.entities.utils.EatingProcess;

import com.island.entities.utils.MovingProcess;
...
public abstract class Animal extends SimulationItem {
    ...
    public boolean eat() {
        ...
        EatingProcess eatingManager = new EatingProcess();
    ...
    public boolean move(MovingProcess movementManager) {
